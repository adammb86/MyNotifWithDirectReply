package com.example.adammb.mynotifwithdirectreply;
...
import static com.example.adammb.mynotifwithdirectreply.NotificationService.REPLY_ACTION;
...
public class NotificationBroadcastReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        if(REPLY_ACTION.equals(intent.getAction())){
            CharSequence message = NotificationService.getReplyMessageIntent(intent);
    ...
    private void updateNotification(Context context, int notifyId) {
        ...
        NotificationCompat.Builder builder=new NotificationCompat.Builder(context,"My Second Notif")
