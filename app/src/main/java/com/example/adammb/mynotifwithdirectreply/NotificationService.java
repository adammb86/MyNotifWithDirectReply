...
public class NotificationService extends IntentService {
    public static String REPLY_ACTION = "com.example.adammb.mynotifwithdirectreply.REPLY_ACTION";
    ...
    private void showNotification() {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, "My Direct Reply Notif")
    ...
    public static CharSequence getReplyMessageIntent(Intent intent){
